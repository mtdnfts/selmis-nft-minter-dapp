const contractAddress = "0x20cA55E676B1608bdbD34D70E9a6C26F2C12911f"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Selmi's NFT Exlusive Benefits Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "Minting (purchasing) a Selmi's NFT will get you access to all the benefits listed down below at Selmi's Farm! To redeem benefits at check-out use tokenhound.xyz and scan your Selmi's NFT QR code.";
...
const p_presale_mint_not_whitelisted = "To get whitelisted email mtd.nfts@gmail.com";
...
const p_public_mint = "Minting only one NFT is needed to join the Selmi's Exclusive Benefits Club";
const button_presale_coming_soon = "Get on the Whitelist";
const button_presale_mint_whitelisted = "Mint Your Selmi's NFT";
...
const benefits_h1 = "List of Benefits";
